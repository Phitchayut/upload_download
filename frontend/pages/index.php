                    ...
                    <table class="table table-striped  table-hover table-responsive table-bordered" id="tbl_file_upload">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="width: 30%;">ชื่อเอกสาร</th>
                        ...
                        <tbody class="text-center">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-start"><?= $row['status_input'] == 1 ? "<p class='text-success'>กรอกข้อมูล</p>" : "<p class='text-danger'>ไม่กรอกข้อมูล</p>"; ?></td>
                                    <td>
                                        <p>
                                            <?= $row['status_input'] == 1 ?
